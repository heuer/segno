...
def test_hexcolor_too_long():
    qr = segno.make_qr('test')
    qr.png(io.BytesIO(), color='#0000000')
...
def test_color_eq_background():
    qr = segno.make_qr('test')
    qr.png(io.BytesIO(), color='#000', background='#000')
...
def test_greyscale():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='#000', background='#fff')
...
def test_greyscale2():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='white', background='black')
    ok_(not _has_palette(out.getvalue()))
    ok_(not _has_transparency(out.getvalue()))
...
def test_greyscale_trans():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='#000', background=None)
    ok_(not _has_palette(out.getvalue()))
...
def test_greyscale_trans2():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color=None, background='white')
    ok_(not _has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
...
def test_color():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='blue', background='white')
...
def test_color_trans():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='blue', background=None)
    ok_(_has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
...
def test_color_trans2():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color=None, background='green')
    ok_(_has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
...
def test_color_rgba():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='#0000ffcc', background='white')
    ok_(_has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
...
def test_color_rgba2():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='#000', background='#0000ffcc')
    ok_(_has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
...
def test_color_rgba_and_trans():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color='#0000ffcc', background=None)
    ok_(_has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
...
def test_color_rgba_and_trans2():
    qr = segno.make_qr('test')
    out = io.BytesIO()
    qr.png(out, color=None, background='#0000ffcc')
    ok_(_has_palette(out.getvalue()))
    ok_(_has_transparency(out.getvalue()))
